...
package ru.mirea.fedorov.lesson4.serviceapp.databinding;
...
import ru.mirea.fedorov.lesson4.serviceapp.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonPlay,
      @NonNull Button buttonStop, @NonNull TextView textStatus, @NonNull TextView textSubtitle,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, buttonPlay, buttonStop,
          textStatus, textSubtitle, textTitle);
    }
